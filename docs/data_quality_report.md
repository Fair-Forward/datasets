# Data Quality Report
Generated: 2026-03-26 13:02

## Summary
- **72** projects evaluated
- **Average score: 76/100** (range 24-100)
- **2** projects below 50/100 (need attention)
- **0** license values need review
- **1** organization fields contain email addresses
- **0** unrecognized country names
- **15** flagged URLs (see details below)

## Projects Needing Attention (score < 50)

| Project | Score | Missing Fields |
|---|---|---|
| Forest carbon sequestration in the Congo Basin: combining In | 24 | description, data_characteristics, how_to_use, model_characteristics, license, SDGs, data_types |
...
## Organization Fields with Email Addresses

These entries may contain person names instead of organization names.

| Project | Value (excerpt) |
|---|---|
| Phenological Dataset for Ecological Forecasting (PheDEF Proj | Powered by:  Bismark Ofosu-Bamfo (bismark.ofosu-bamfo@uenr.edu.gh; bofosubamfo@gmail.com), Daniel Ya |
...
| https://www.recoftc.org/projects/advancing-oil-palm-mapping-social-forestry-and-machine-learning | 403 | Mitigating the impacts of oil palm culti |
