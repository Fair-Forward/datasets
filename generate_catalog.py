...
<head>
    ...
    <style>
        body {{
            ...
            color: #4e3276;  /* Rich purple text color */
        }}
        header {{
            background-color: #4e3276; /* Rich purple for header */
            color: #ffffff;
        }}
        footer {{
            background-color: #4e3276; /* Rich purple for footer */
            color: #ffffff;
        }}
        .btn-primary {{
            background-color: #36e0b8; /* Teal color for buttons */
            border-color: #36e0b8;
            color: #ffffff;
        }}
        .btn-info {{
            background-color: #36e0b8; /* Teal color for details button */
            border-color: #36e0b8;
            color: #ffffff;
        }}
        .btn-success {{
            background-color: #36e0b8; /* Teal color for use-case button */
            border-color: #36e0b8;
            color: #ffffff;
        }}
    </style>
