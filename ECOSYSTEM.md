...
below it using the same six fields, in the same order: URL, Holds, Geography, Openness, Machine
access, Operator / funders, followed by a note of one or two lines saying what it is and how it
relates to our catalog. Lists of organisations rather than of projects go in the second section as a single
bullet.
